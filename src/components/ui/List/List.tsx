...
import { filterEvents, getByAvailability } from '../../utils/filters';
...
export const List = ({ events, onEventSelect }: ListProps) => {
        ...
        <div className="row">
          <main>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {upcoming.map((event) => (
                <Card key={event.id} event={event} onCardSelect={onEventSelect} />
              ))}
            </div>
